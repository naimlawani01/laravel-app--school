            ...
            <div class="col-md-12">
              <div class="card card-outline card-info">
                ...
                <div class="card-body pad">
                        <form role="form" method="POST" id="quickForm" enctype="multipart/form-data" action="{{ route('post.store') }}" >
                                @method('put')
                                @csrf
                        <div class="row">
                                <div class="col-md-8">
                                        <div class="form-group">
                                                <input type="text" name="title" class="form-control" id="exampleInputPassword1" placeholder="Entrer le nom">
                                              </div>
                                </div>
                                <div class="col-md-4">
